...
void ddr_init(void)
{
	...
	if (ddr_size != PHYBOARD_POLARIS_2GB) {
		...
		reg32_write(0x3d4030e8,0x66004a);
		reg32_write(0x3d4030ec,0x16004a);
		...
		reg32_write(0x3d403180,0xc0190004);
