...
enum phytec_phyflex_imx8mp_ddr_code {
	PHYTEC_PHYFLEX_IMX8MP_DDR_1GB = 0,
	PHYTEC_PHYFLEX_IMX8MP_DDR_2GB = 1,
	PHYTEC_PHYFLEX_IMX8MP_DDR_4GB = 2,
	PHYTEC_PHYFLEX_IMX8MP_DDR_8GB = 3,
};
